...
export default function Header() {
   return (
      <header className="py-6 border-b xs:flex w-full justify-between items-center">
         <div>
            <h1 className="mb-0">react-use-focus-within</h1>
            <p className="m-0 p-0 pt-1">
               A react hook for detecting if the current focus resides within an
               specific DOM element.
            </p>
         </div>
         <a
            href="https://github.com/dcooney/react-use-focus-within"
